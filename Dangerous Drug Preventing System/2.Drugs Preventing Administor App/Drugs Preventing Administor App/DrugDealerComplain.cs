...
{
    public partial class DrugDealerComplain : Form
    {
        int pid;
        public DrugDealerComplain(int pid2)
        {
            InitializeComponent();
            pid = pid2;
        }
        ...
        private void DrugDealerComplain_Load(object sender, EventArgs e)
        {
            con.Open();

            string sql = "SELECT * FROM ComplainDrugDelearTbl";
            ...
            while (dr.Read())
            {
                ListViewItem table = new ListViewItem(dr["DealerID"].ToString());
        ...
        {
            if (cbProvince.Text != "" && dealerid.Text != "" && userid.Text != "")
            {
                con.Open();

                string sql = "SELECT * FROM ComplainDrugDelearTbl WHERE (Province = '"+cbProvince.Text+"' AND DealerID = '"+dealerid.Text+"' AND UserID = '"+userid.Text+"')";
                com = new SqlCommand(sql, con);
                dr = com.ExecuteReader();
            ...
            else if (cbProvince.Text != "" && dealerid.Text != "" && userid.Text == "")
            {
                con.Open();

                string sql = "SELECT * FROM ComplainDrugDelearTbl WHERE (Province = '" + cbProvince.Text + "' AND DealerID = '" + dealerid.Text + "')";
                com = new SqlCommand(sql, con);
                dr = com.ExecuteReader();
            ...
            else if (cbProvince.Text != "" && dealerid.Text == "" && userid.Text != "")
            {
                ...
                string sql = "SELECT * FROM ComplainDrugDelearTbl WHERE (Province = '" + cbProvince.Text + "' AND UserID = '" + userid.Text + "')";
                com = new SqlCommand(sql, con);
                dr = com.ExecuteReader();
            ...
            else if (cbProvince.Text != "" && dealerid.Text == "" && userid.Text == "")
            {
                ...
                string sql = "SELECT * FROM ComplainDrugDelearTbl WHERE (Province = '" + cbProvince.Text + "')";
                com = new SqlCommand(sql, con);
                dr = com.ExecuteReader();
            ...
            else if (cbProvince.Text == "" && dealerid.Text != "" && userid.Text != "")
            {
                ...
                string sql = "SELECT * FROM ComplainDrugDelearTbl WHERE (DealerID = '" + dealerid.Text + "' AND UserID = '" + userid.Text + "')";
                com = new SqlCommand(sql, con);
                dr = com.ExecuteReader();
            ...
            else if (cbProvince.Text == "" && dealerid.Text != "" && userid.Text == "")
            {
                ...
                string sql = "SELECT * FROM ComplainDrugDelearTbl WHERE (DealerID = '" + dealerid.Text + "')";
                com = new SqlCommand(sql, con);
                dr = com.ExecuteReader();
            ...
            else if (cbProvince.Text == "" && dealerid.Text == "" && userid.Text != "")
            {
                ...
                string sql = "SELECT * FROM ComplainDrugDelearTbl WHERE (UserID = '" + userid.Text + "')";
                com = new SqlCommand(sql, con);
                dr = com.ExecuteReader();
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (listView1.SelectedItems.Count > 0)
                {
                    ...
                    tbDealerID.Text = srecord.SubItems[0].Text;
                    ...
                    con.Open();
                    string sql = "SELECT Image FROM ComplainDrugDelearTbl WHERE DealerID = '"+tbDealerID.Text+"'";
                    com = new SqlCommand(sql, con);
                    dr = com.ExecuteReader();
                    if (dr.Read())
                    {
